...
def run_agent(question: str):
    ...
    chat_model = init_chat_model(f"ollama:{MODEL}",temperature=0.0)
    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "and a discount tool.\n\n"
                "STRICT RULE - you must follow them exactly:\n"
                "1. Never guess or assume product price. "
                "2. you MUST call apply_discount AFTER you have received "
